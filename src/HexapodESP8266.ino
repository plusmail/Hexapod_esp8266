...
const char WiFiAPPSK[] = "hexapod1234";

RH_NRF24 nrf24(2, 15); // use this for NodeMCU Amica/AdaFruit Huzzah ESP8266 Feather
...
class RH_NRF24_Sch : public Task {
public:
    void loop() {
...
{   // main Setup
  ...
  {    
    ...
    Wire.begin(D2, D1); //pins D3 and D4
